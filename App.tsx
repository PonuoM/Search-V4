...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const fetchGithubData = async () => {
      ...
      try {
        // Add a timestamp as a query parameter to prevent caching issues.
        // This ensures the latest version of the Excel file is always fetched.
        const urlWithCacheBuster = `${GITHUB_SALES_DATA_URL}?t=${new Date().getTime()}`;
